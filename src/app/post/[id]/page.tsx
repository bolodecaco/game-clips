        ...
        <div className="grid gap-8 lg:grid-cols-3">
              ...
              <CardContent className="p-0">
                {post.mediaType === "video" ? (
                  <div className="video-container">
                    <video controls className="w-full rounded-lg" poster="/placeholder.svg?height=400&width=600">
                      <source src={post.mediaUrl} type="video/mp4" />
                      Seu navegador não suporta o elemento de vídeo.
                    </video>
                  </div>
                ) : (
                  <img src={post.mediaUrl || "/placeholder.svg"} alt={post.title} className="w-full rounded-lg" />
                )}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      <Button
                        variant="ghost"
                        onClick={handleLike}
                        className={`transition-all duration-200 hover:scale-110 ${post.isLiked ? "text-red-500" : ""}`}
                      >
          ...
          <div className="space-y-6">
            ...
            <Card className="animate-slide-up" style={{ animationDelay: "0.1s" }}>
              <CardHeader>
                <h3 className="font-semibold">Comentários ({post.comments.length})</h3>
              </CardHeader>
