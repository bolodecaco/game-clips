      ...
      <main className="container mx-auto px-4 py-8 max-w-2xl">
        <Card className="animate-fade-in">
          <CardHeader>
            ...
            <CardDescription>Compartilhe seus melhores momentos de gaming com a comunidade</CardDescription>
          </CardHeader>
                ...
                {!mediaPreview ? (
                  <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-8 text-center hover:border-muted-foreground/50 transition-colors">
                    ...
                    <label htmlFor="media-upload" className="cursor-pointer">
                      ...
                      <p className="text-sm text-muted-foreground">Suporte para imagens e vídeos (máx. 50MB)</p>
                    </label>
                  </div>
                ) : (
                ...
                <Select value={genre} onValueChange={setGenre} required>
                  ...
                  <SelectContent>
                    {genres.map((genreItem) => (
                      <SelectItem key={genreItem.id} value={genreItem.id}>
                        {genreItem.name}
                      </SelectItem>
                    ))}
                  </SelectContent>
